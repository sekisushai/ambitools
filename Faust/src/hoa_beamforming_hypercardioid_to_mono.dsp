...
// Output gain
vol	=	vslider("[2]Output Gain", 0, -10, 10, 0.1) : db2linear : smooth(0.999);
...
process		=	hgroup("Inputs",par(i,M+1,metermute(i)):yvec((M+1)^2,t,d)<:par(m,M,gvec(m+1,M):>_*vol):selectn(M,order-1)):hgroup("Output",hmeter)<:(_,_);