...
row(i)= par(j,(M+1)^2,yacn(j,azimuth(i),elevation(i))*weight3(i));

process=hgroup("Inputs",selecteur:matrix((M+1)^2,26)):(hgroup("Outputs 1-13",par(i,13,id2(i,0))),hgroup("Outputs 14-26",par(i,13,id2(i,13))));