...
theta1=vslider("[04][osc:/source1_theta 0 360]Source 1 Theta", 0, 0, 360, 0.1)*PI/180;
delta1=vslider("[05][osc:/source1_delta -90 90]Source 1 Delta", 0, -90, 90, 0.1)*PI/180;

theta2=vslider("[09][osc:/source2_theta 0 360]Source 2 Theta", 0, 0, 360, 0.1)*PI/180;
delta2=vslider("[10][osc:/source2_delta -90 90]Source 2 Delta", 0, -90, 90, 0.1)*PI/180;

// Plane wave
plane(t,d)=_<:ytot(t,d);

// Spherical wave : near-field filters included
spherical(r,t,d)=_<:((nf0<:bus(1)),(nf1(r,rhp)<:bus(3)),(nf2(r,rhp)<:bus(5)),(nf3(r,rhp)<:bus(7)),(nf4(r,rhp)<:bus(9)),(nf5(r,rhp)<:bus(11)));
