...
updownsig1	=	par(i,ins,_<:select2(trig,*(vol*compteurbas1),*(vol*compteurhaut1))):yvec(ins,theta0,delta0):>_*(1/(4*PI))<:yvec(outs,theta0,delta0):bus(outs);
updownsig2	=	par(i,ins,_<:select2(trig,*(compteurhaut2),*(compteurbas2))):bus(outs);
selecteur	=	hgroup("Parameters",hgroup("[1]Inputs",par(i,M+1,meterm(i)))<:((updownsig2),(updownsig1)):>bus(outs));
