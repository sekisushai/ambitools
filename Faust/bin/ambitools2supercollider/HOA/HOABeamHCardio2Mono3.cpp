...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("name", "HOABeamHCardio2Mono3");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("0x3253cb0", &fVbargraph0, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("1");
		ui_interface->openVerticalBox("1");
		ui_interface->declare(&fVbargraph2, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3261a80", &fVbargraph2, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("2");
		ui_interface->declare(&fVbargraph1, "unit", "dB");
		ui_interface->addVerticalBargraph("0x325a870", &fVbargraph1, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("3");
		ui_interface->declare(&fVbargraph3, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3267270", &fVbargraph3, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("2");
		ui_interface->openVerticalBox("4");
		ui_interface->declare(&fVbargraph8, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3286c10", &fVbargraph8, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("5");
		ui_interface->declare(&fVbargraph6, "unit", "dB");
		ui_interface->addVerticalBargraph("0x327a6e0", &fVbargraph6, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("6");
		ui_interface->declare(&fVbargraph4, "unit", "dB");
		ui_interface->addVerticalBargraph("0x326eab0", &fVbargraph4, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("7");
		ui_interface->declare(&fVbargraph5, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3275390", &fVbargraph5, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("8");
		ui_interface->declare(&fVbargraph7, "unit", "dB");
		ui_interface->addVerticalBargraph("0x32810a0", &fVbargraph7, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("3");
		ui_interface->openVerticalBox("9");
		ui_interface->declare(&fVbargraph11, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3299820", &fVbargraph11, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("10");
		ui_interface->declare(&fVbargraph12, "unit", "dB");
		ui_interface->addVerticalBargraph("0x329f310", &fVbargraph12, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("11");
		ui_interface->declare(&fVbargraph9, "unit", "dB");
		ui_interface->addVerticalBargraph("0x328dbd0", &fVbargraph9, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("12");
		ui_interface->declare(&fVbargraph14, "unit", "dB");
		ui_interface->addVerticalBargraph("0x32ace00", &fVbargraph14, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("13");
		ui_interface->declare(&fVbargraph10, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3293000", &fVbargraph10, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("14");
		ui_interface->declare(&fVbargraph15, "unit", "dB");
		ui_interface->addVerticalBargraph("0x32b29c0", &fVbargraph15, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("15");
		ui_interface->declare(&fVbargraph13, "unit", "dB");
		ui_interface->addVerticalBargraph("0x32a5330", &fVbargraph13, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->declare(&fVslider0, "1", "");
		ui_interface->addVerticalSlider("Order", &fVslider0, 1.0, 1.0, 3.0, 1.0);
		...
		ui_interface->addHorizontalBargraph("0x32b85a0", &fHbargraph0, -70.0, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		int iSlow0 = (int(double(fVslider0)) + -1);
		int iSlow1 = (iSlow0 >= 2);
		int iSlow2 = (iSlow0 >= 1);
		double fSlow3 = (0.0010000000000000009 * pow(10.0, (0.050000000000000003 * double(fVslider1))));
		double fSlow4 = double(fVslider2);
		double fSlow5 = sin(fSlow4);
		double fSlow6 = cos(fSlow4);
		double fSlow7 = double(fVslider3);
		double fSlow8 = sin(fSlow7);
		double fSlow9 = cos(fSlow7);
		double fSlow10 = faustpower2_f(fSlow5);
		double fSlow11 = ((3.0 * fSlow10) + -1.0);
		double fSlow12 = (0.124224 * fSlow11);
		double fSlow13 = sin((2.0 * fSlow4));
		double fSlow14 = faustpower2_f(fSlow6);
		double fSlow15 = (2.0 * fSlow7);
		double fSlow16 = cos(fSlow15);
		double fSlow17 = sin(fSlow15);
		double fSlow18 = (5.0 * fSlow10);
		double fSlow19 = (0.10126496782883505 * (fSlow18 + -1.0));
		double fSlow20 = (3.0 * fSlow7);
		double fSlow21 = (0.130732511318436 * (sin(fSlow20) * fSlow6));
		double fSlow22 = (0.32022794552279471 * (fSlow17 * fSlow5));
		double fSlow23 = (0.130732511318436 * (cos(fSlow20) * fSlow6));
		double fSlow24 = (0.069875499999999993 * fSlow11);
		double fSlow25 = (0.082682500000000006 * (fSlow18 + -3.0));
		double fSlow26 = (0.32022794552279471 * (fSlow16 * fSlow14));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp4 = ((fSlow5 * fTemp1) + (fSlow6 * ((fSlow8 * fTemp2) + (fSlow9 * fTemp3))));
			...
			double fTemp10 = ((fSlow13 * ((fSlow9 * fTemp6) + (fSlow8 * fTemp7))) + (fSlow14 * ((fSlow16 * fTemp8) + (fSlow17 * fTemp9))));
			double fTemp11 = double(input11[i]);
			fRec11[0] = max((fRec11[1] - fConst0), min(6.0, (20.0 * log10(max(0.00031622776601683794, fabs(fTemp11))))));
			...
			fRec13[0] = max((fRec13[1] - fConst0), min(6.0, (20.0 * log10(max(0.00031622776601683794, fabs(fTemp13))))));
			...
			fRec15[0] = max((fRec15[1] - fConst0), min(6.0, (20.0 * log10(max(0.00031622776601683794, fabs(fTemp15))))));
			...
			fRec17[0] = max((fRec17[1] - fConst0), min(6.0, (20.0 * log10(max(0.00031622776601683794, fabs(fTemp17))))));
			fVbargraph15 = FAUSTFLOAT(fRec17[0]);
			double fTemp18 = (iSlow1?(fRec1[0] * ((fSlow6 * ((fSlow19 * ((fSlow8 * fTemp11) + (fSlow9 * fTemp12))) + (fSlow6 * (((fSlow21 * fTemp13) + (fSlow22 * fTemp14)) + (fSlow23 * fTemp15))))) + ((0.12102791620427908 * fTemp10) + ((fSlow24 * fTemp5) + ((0.108241 * fTemp4) + ((0.062512799999999993 * fTemp0) + (fSlow5 * ((fSlow25 * fTemp16) + (fSlow26 * fTemp17))))))))):(iSlow2?(fRec1[0] * (((fSlow12 * fTemp5) + ((0.11112 * fTemp0) + (0.19245000000000004 * fTemp4))) + (0.2151622795194362 * fTemp10))):(fRec1[0] * ((0.24993000000000001 * fTemp0) + (0.43301700000000004 * fTemp4)))));
			fRec0[0] = max((fRec0[1] - fConst0), min(6.0, (20.0 * log10(max(0.00031622776601683794, fabs(fTemp18))))));
