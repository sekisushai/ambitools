 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp75 = float(input25[i]);
			float fTemp76 = (iSlow5?(0.0f - fTemp75):fTemp75);
			float fTemp77 = (iSlow6?(0.0f - fTemp76):fTemp76);
			output25[i] = FAUSTFLOAT((iSlow1?(0.0f - fTemp77):fTemp77));
			float fTemp78 = float(input26[i]);
			float fTemp79 = (iSlow7?(0.0f - fTemp78):fTemp78);
			float fTemp80 = (iSlow6?(0.0f - fTemp79):fTemp79);
			output26[i] = FAUSTFLOAT((iSlow8?(0.0f - fTemp80):fTemp80));
			float fTemp81 = float(input27[i]);
			float fTemp82 = (iSlow5?(0.0f - fTemp81):fTemp81);
			float fTemp83 = (iSlow6?(0.0f - fTemp82):fTemp82);
			output27[i] = FAUSTFLOAT((iSlow1?(0.0f - fTemp83):fTemp83));
			float fTemp84 = float(input28[i]);
			float fTemp85 = (iSlow7?(0.0f - fTemp84):fTemp84);
			float fTemp86 = (iSlow6?(0.0f - fTemp85):fTemp85);
			output28[i] = FAUSTFLOAT((iSlow8?(0.0f - fTemp86):fTemp86));
			float fTemp87 = float(input29[i]);
			float fTemp88 = (iSlow5?(0.0f - fTemp87):fTemp87);
			float fTemp89 = (iSlow6?(0.0f - fTemp88):fTemp88);
			output29[i] = FAUSTFLOAT((iSlow1?(0.0f - fTemp89):fTemp89));
			float fTemp90 = float(input30[i]);
			float fTemp91 = (iSlow7?(0.0f - fTemp90):fTemp90);
			float fTemp92 = (iSlow3?(0.0f - fTemp91):fTemp91);
			output30[i] = FAUSTFLOAT((iSlow1?(0.0f - fTemp92):fTemp92));
			float fTemp93 = float(input31[i]);
			float fTemp94 = (iSlow5?(0.0f - fTemp93):fTemp93);
			float fTemp95 = (iSlow3?(0.0f - fTemp94):fTemp94);
			output31[i] = FAUSTFLOAT((iSlow8?(0.0f - fTemp95):fTemp95));
			float fTemp96 = float(input32[i]);
			float fTemp97 = (iSlow7?(0.0f - fTemp96):fTemp96);
			float fTemp98 = (iSlow3?(0.0f - fTemp97):fTemp97);
			output32[i] = FAUSTFLOAT((iSlow1?(0.0f - fTemp98):fTemp98));
			float fTemp99 = float(input33[i]);
			float fTemp100 = (iSlow5?(0.0f - fTemp99):fTemp99);
			float fTemp101 = (iSlow3?(0.0f - fTemp100):fTemp100);
			output33[i] = FAUSTFLOAT((iSlow8?(0.0f - fTemp101):fTemp101));
			float fTemp102 = float(input34[i]);
			float fTemp103 = (iSlow7?(0.0f - fTemp102):fTemp102);
			float fTemp104 = (iSlow3?(0.0f - fTemp103):fTemp103);
			output34[i] = FAUSTFLOAT((iSlow1?(0.0f - fTemp104):fTemp104));
			float fTemp105 = float(input35[i]);
			float fTemp106 = (iSlow5?(0.0f - fTemp105):fTemp105);
			float fTemp107 = (iSlow3?(0.0f - fTemp106):fTemp106);
			output35[i] = FAUSTFLOAT((iSlow8?(0.0f - fTemp107):fTemp107));
