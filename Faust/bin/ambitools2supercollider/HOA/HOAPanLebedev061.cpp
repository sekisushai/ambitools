...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("0x3a730c0", &fVbargraph0, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("2");
		ui_interface->declare(&fVbargraph1, "osc", "/output2");
		ui_interface->declare(&fVbargraph1, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3a78a30", &fVbargraph1, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("3");
		ui_interface->declare(&fVbargraph2, "osc", "/output3");
		ui_interface->declare(&fVbargraph2, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3a7eb90", &fVbargraph2, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("4");
		ui_interface->declare(&fVbargraph3, "osc", "/output4");
		ui_interface->declare(&fVbargraph3, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3a84dd0", &fVbargraph3, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("5");
		ui_interface->declare(&fVbargraph4, "osc", "/output5");
		ui_interface->declare(&fVbargraph4, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3a8b0f0", &fVbargraph4, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("6");
		ui_interface->declare(&fVbargraph5, "osc", "/output6");
		ui_interface->declare(&fVbargraph5, "unit", "dB");
		ui_interface->addVerticalBargraph("0x3a90d00", &fVbargraph5, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow9 = (6.12323426e-17f * (fSlow6 * fSlow8));
		float fSlow10 = sinf(fSlow7);
		float fSlow11 = (1.0f - float(fCheckbox2));
		float fSlow12 = (3.0f * ((fSlow9 + fSlow10) * fSlow11));
		float fSlow13 = ((fConst3 / fSlow0) + 1.0f);
		float fSlow14 = (fConst2 / (fSlow13 * fSlow0));
		float fSlow15 = (1.0f / ((fConst3 / fSlow2) + 1.0f));
		float fSlow16 = (((fSlow13 * fSlow1) * fSlow2) / fSlow0);
		float fSlow17 = (fConst2 / fSlow2);
		float fSlow18 = ((1.0f - fSlow1) * fSlow2);
		float fSlow19 = (3.0f * ((fSlow6 * fSlow11) * fSlow8));
		float fSlow20 = (3.0f * ((cosf((fSlow5 + -1.57079637f)) * fSlow11) * fSlow8));
		float fSlow21 = (3.0f * ((cosf((fSlow5 + -3.14159274f)) * fSlow11) * fSlow8));
		float fSlow22 = (3.0f * ((cosf((fSlow5 + -4.71238899f)) * fSlow11) * fSlow8));
		float fSlow23 = (3.0f * ((fSlow9 - fSlow10) * fSlow11));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec3[0] = (fSlow15 * ((fSlow16 * fTemp0) - (fSlow17 * fRec4[0])));
			fRec2[0] = (fRec3[0] + fRec2[1]);
			fRec6[0] = (fRec5[1] + fRec6[1]);
			fRec5[0] = (fSlow15 * ((fSlow18 * fTemp0) - (fSlow17 * fRec6[0])));
			float fTemp2 = ((fSlow14 * (fRec2[0] - fRec3[0])) + (fRec3[0] + fRec5[0]));
			float fTemp3 = (0.166666672f * (fTemp1 + (fSlow12 * fTemp2)));
			...
			float fTemp4 = (0.166666672f * (fTemp1 + (fSlow19 * fTemp2)));
			...
			float fTemp5 = (0.166666672f * (fTemp1 + (fSlow20 * fTemp2)));
			...
			float fTemp6 = (0.166666672f * (fTemp1 + (fSlow21 * fTemp2)));
			...
			float fTemp7 = (0.166666672f * (fTemp1 + (fSlow22 * fTemp2)));
			...
			float fTemp8 = (0.166666672f * (fTemp1 + (fSlow23 * fTemp2)));
