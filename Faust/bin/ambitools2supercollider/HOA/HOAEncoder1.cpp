...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("0x2833f90", &fVbargraph0, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("1");
		ui_interface->openVerticalBox("1");
		ui_interface->declare(&fVbargraph1, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2845b20", &fVbargraph1, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("2");
		ui_interface->declare(&fVbargraph2, "unit", "dB");
		ui_interface->addVerticalBargraph("0x284b8d0", &fVbargraph2, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("3");
		ui_interface->declare(&fVbargraph3, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2851860", &fVbargraph3, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow8 = (1.73205078f * (sinf(fSlow5) * fSlow7));
		float fSlow9 = ((fConst3 / fSlow1) + 1.0f);
		float fSlow10 = (fConst2 / (fSlow9 * fSlow1));
		float fSlow11 = (1.0f / ((fConst3 / fSlow0) + 1.0f));
		float fSlow12 = (((fSlow9 * fSlow2) * fSlow0) / fSlow1);
		float fSlow13 = (fConst2 / fSlow0);
		float fSlow14 = (1.0f - fSlow2);
		float fSlow15 = (1.73205078f * sinf(fSlow6));
		float fSlow16 = (1.73205078f * (cosf(fSlow5) * fSlow7));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec4[0] = (fSlow11 * ((fSlow12 * fTemp0) - (fSlow13 * fRec5[0])));
			fRec3[0] = (fRec3[1] + fRec4[0]);
			float fTemp2 = ((fSlow10 * (fRec3[0] - fRec4[0])) + (fRec4[0] + (fSlow14 * fTemp0)));
			float fTemp3 = (fSlow8 * fTemp2);
			fRec2[0] = max((fRec2[1] - fConst1), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp3))))));
			fVbargraph1 = FAUSTFLOAT(fRec2[0]);
			output1[i] = FAUSTFLOAT(fTemp3);
			float fTemp4 = (fSlow15 * fTemp2);
			fRec6[0] = max((fRec6[1] - fConst1), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp4))))));
			fVbargraph2 = FAUSTFLOAT(fRec6[0]);
			output2[i] = FAUSTFLOAT(fTemp4);
			float fTemp5 = (fSlow16 * fTemp2);
			fRec7[0] = max((fRec7[1] - fConst1), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp5))))));
