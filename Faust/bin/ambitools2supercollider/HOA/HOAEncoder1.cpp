...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("0x1a25ef0", &fbargraph0, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("1");
		ui_interface->openVerticalBox("1");
		ui_interface->declare(&fbargraph1, "unit", "dB");
		ui_interface->addVerticalBargraph("0x1a2d650", &fbargraph1, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("2");
		ui_interface->declare(&fbargraph2, "unit", "dB");
		ui_interface->addVerticalBargraph("0x1a2fb20", &fbargraph2, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("3");
		ui_interface->declare(&fbargraph3, "unit", "dB");
		ui_interface->addVerticalBargraph("0x1a32160", &fbargraph3, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		double 	fSlow7 = ((fConst3 / fSlow1) + 1);
		double 	fSlow8 = (((fSlow3 * fSlow2) * fSlow7) / fSlow1);
		double 	fSlow9 = (1.0 / ((fConst3 / fSlow2) + 1));
		double 	fSlow10 = (fConst2 / (fSlow1 * fSlow7));
		double 	fSlow11 = double(fslider2);
		double 	fSlow12 = double(fslider3);
		double 	fSlow13 = cos(fSlow12);
		double 	fSlow14 = (1.7320508075688772 * (fSlow13 * sin(fSlow11)));
		double 	fSlow15 = (1.7320508075688772 * sin(fSlow12));
		double 	fSlow16 = (1.7320508075688772 * (fSlow13 * cos(fSlow11)));
		...
		for (int i=0; i<count; i++) {
			...
			fRec3[0] = (fSlow9 * ((fSlow8 * fTemp0) - (fSlow6 * fRec4[0])));
			fRec5[0] = (fRec5[1] + fRec3[0]);
			double fTemp2 = ((fSlow10 * (fRec5[0] - fRec3[0])) + (fRec3[0] + (fSlow5 * fTemp0)));
			double fTemp3 = (fSlow14 * fTemp2);
			fRec2[0] = max((fRec2[1] - fConst1), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp3))))));
			fbargraph1 = fRec2[0];
			output1[i] = (FAUSTFLOAT)fTemp3;
			double fTemp4 = (fSlow15 * fTemp2);
			fRec6[0] = max((fRec6[1] - fConst1), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp4))))));
			fbargraph2 = fRec6[0];
			output2[i] = (FAUSTFLOAT)fTemp4;
			double fTemp5 = (fSlow16 * fTemp2);
			fRec7[0] = max((fRec7[1] - fConst1), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp5))))));
			fbargraph3 = fRec7[0];
