...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("0x25f1970", &fVbargraph0, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("2");
		ui_interface->declare(&fVbargraph1, "unit", "dB");
		ui_interface->addVerticalBargraph("0x25f65a0", &fVbargraph1, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("3");
		ui_interface->declare(&fVbargraph2, "unit", "dB");
		ui_interface->addVerticalBargraph("0x25fb3b0", &fVbargraph2, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("4");
		ui_interface->declare(&fVbargraph3, "unit", "dB");
		ui_interface->addVerticalBargraph("0x26002a0", &fVbargraph3, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("5");
		ui_interface->declare(&fVbargraph4, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2605270", &fVbargraph4, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("6");
		ui_interface->declare(&fVbargraph5, "unit", "dB");
		ui_interface->addVerticalBargraph("0x260a320", &fVbargraph5, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("7");
		ui_interface->declare(&fVbargraph6, "unit", "dB");
		ui_interface->addVerticalBargraph("0x260f860", &fVbargraph6, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("8");
		ui_interface->declare(&fVbargraph7, "unit", "dB");
		ui_interface->addVerticalBargraph("0x26148f0", &fVbargraph7, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("9");
		ui_interface->declare(&fVbargraph8, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2619c40", &fVbargraph8, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("10");
		ui_interface->declare(&fVbargraph9, "unit", "dB");
		ui_interface->addVerticalBargraph("0x261f070", &fVbargraph9, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("11");
		ui_interface->declare(&fVbargraph10, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2624790", &fVbargraph10, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("12");
		ui_interface->declare(&fVbargraph11, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2629d80", &fVbargraph11, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("13");
		ui_interface->declare(&fVbargraph12, "unit", "dB");
		ui_interface->addVerticalBargraph("0x262f450", &fVbargraph12, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("14");
		ui_interface->declare(&fVbargraph13, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2634c00", &fVbargraph13, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("15");
		ui_interface->declare(&fVbargraph14, "unit", "dB");
		ui_interface->addVerticalBargraph("0x263a490", &fVbargraph14, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("16");
		ui_interface->declare(&fVbargraph15, "unit", "dB");
		ui_interface->addVerticalBargraph("0x263fe00", &fVbargraph15, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("17");
		ui_interface->declare(&fVbargraph16, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2645850", &fVbargraph16, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("18");
		ui_interface->declare(&fVbargraph17, "unit", "dB");
		ui_interface->addVerticalBargraph("0x264b380", &fVbargraph17, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("19");
		ui_interface->declare(&fVbargraph18, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2651520", &fVbargraph18, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("20");
		ui_interface->declare(&fVbargraph19, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2657030", &fVbargraph19, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("21");
		ui_interface->declare(&fVbargraph20, "unit", "dB");
		ui_interface->addVerticalBargraph("0x265ce00", &fVbargraph20, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("22");
		ui_interface->declare(&fVbargraph21, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2662cb0", &fVbargraph21, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("23");
		ui_interface->declare(&fVbargraph22, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2668e50", &fVbargraph22, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("24");
		ui_interface->declare(&fVbargraph23, "unit", "dB");
		ui_interface->addVerticalBargraph("0x266eec0", &fVbargraph23, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("25");
		ui_interface->declare(&fVbargraph24, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2675010", &fVbargraph24, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("26");
		ui_interface->declare(&fVbargraph25, "unit", "dB");
		ui_interface->addVerticalBargraph("0x267b240", &fVbargraph25, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addVerticalBargraph("0x2684c50", &fVbargraph26, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("1");
		ui_interface->openVerticalBox("1");
		ui_interface->declare(&fVbargraph27, "unit", "dB");
		ui_interface->addVerticalBargraph("0x268e8f0", &fVbargraph27, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("2");
		ui_interface->declare(&fVbargraph28, "unit", "dB");
		ui_interface->addVerticalBargraph("0x2695580", &fVbargraph28, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("3");
		ui_interface->declare(&fVbargraph29, "unit", "dB");
		ui_interface->addVerticalBargraph("0x269eef0", &fVbargraph29, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("2");
		ui_interface->openVerticalBox("4");
		ui_interface->declare(&fVbargraph30, "unit", "dB");
		ui_interface->addVerticalBargraph("0x26a7d70", &fVbargraph30, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("5");
		ui_interface->declare(&fVbargraph31, "unit", "dB");
		ui_interface->addVerticalBargraph("0x26af5f0", &fVbargraph31, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("6");
		ui_interface->declare(&fVbargraph32, "unit", "dB");
		ui_interface->addVerticalBargraph("0x26b77b0", &fVbargraph32, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("7");
		ui_interface->declare(&fVbargraph33, "unit", "dB");
		ui_interface->addVerticalBargraph("0x26bf4a0", &fVbargraph33, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("8");
		ui_interface->declare(&fVbargraph34, "unit", "dB");
		ui_interface->addVerticalBargraph("0x26c9020", &fVbargraph34, -70.0f, 6.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp31 = (fTemp8 + fTemp17);
			float fTemp32 = (fTemp21 + fTemp26);
			float fTemp33 = (fTemp19 + fTemp24);
			float fTemp34 = (fTemp22 + fTemp27);
			float fTemp35 = (fRec27[0] * (((0.032142859f * fTemp30) + ((0.0466569476f * (fTemp11 - fTemp13)) + ((0.0824786127f * (fTemp2 - fTemp4)) + ((5.71382825e-18f * fTemp31) + (1.01007165e-17f * fTemp3))))) - ((0.032142859f * (fTemp32 - fTemp33)) + ((0.032142859f * fTemp34) + (0.0466569476f * ((fTemp18 + (fTemp9 + fTemp14)) - (fTemp16 + (fTemp7 + fTemp12))))))));
			fRec28[0] = max((fRec28[1] - fConst0), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp35))))));
			fVbargraph27 = FAUSTFLOAT(fRec28[0]);
			output1[i] = FAUSTFLOAT(fTemp35);
			float fTemp36 = (fTemp0 - fTemp5);
			float fTemp37 = (fRec27[0] * ((0.0824786127f * fTemp36) - ((0.0466569476f * ((fTemp18 + (fTemp17 + (fTemp15 + fTemp16))) - fTemp10)) + (0.032142859f * ((fTemp27 + (fTemp26 + (fTemp24 + fTemp25))) - fTemp23)))));
			fRec29[0] = max((fRec29[1] - fConst0), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp37))))));
			fVbargraph28 = FAUSTFLOAT(fRec29[0]);
			output2[i] = FAUSTFLOAT(fTemp37);
			float fTemp38 = (fTemp7 + fTemp16);
			float fTemp39 = (fTemp9 + fTemp18);
			float fTemp40 = (fRec27[0] * ((((0.032142859f * fTemp33) + ((0.0824786127f * (fTemp1 - fTemp3)) + ((5.05035826e-18f * (fTemp5 + (fTemp0 + fTemp2))) + ((2.85691412e-18f * fTemp38) + (0.0466569476f * fTemp14))))) + (0.032142859f * (fTemp34 - fTemp30))) - ((0.0466569476f * ((fTemp17 + (fTemp8 + fTemp13)) - (fTemp15 + (fTemp6 + fTemp11)))) + ((0.032142859f * fTemp32) + (((1.51510752e-17f * fTemp4) + (0.0466569476f * fTemp12)) + (8.57074258e-18f * fTemp39))))));
			fRec30[0] = max((fRec30[1] - fConst0), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp40))))));
			fVbargraph29 = FAUSTFLOAT(fRec30[0]);
			output3[i] = FAUSTFLOAT(fTemp40);
			float fTemp41 = (fRec27[0] * (((1.35515337e-17f * fTemp39) + (((1.12929443e-17f * fTemp2) + (3.3878833e-17f * fTemp4)) + (4.5171779e-18f * fTemp38))) - ((((2.25858887e-17f * fTemp3) + (9.03435581e-18f * fTemp31)) + (0.0737711117f * ((fTemp12 + fTemp14) - (fTemp11 + fTemp13)))) + (0.0414962508f * ((fTemp27 + (fTemp25 + (fTemp20 + fTemp22))) - (fTemp26 + (fTemp24 + (fTemp19 + fTemp21))))))));
			fRec31[0] = max((fRec31[1] - fConst0), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp41))))));
			fVbargraph30 = FAUSTFLOAT(fRec31[0]);
			output4[i] = FAUSTFLOAT(fTemp41);
			float fTemp42 = ((fTemp19 + fTemp26) - (fTemp21 + fTemp24));
			float fTemp43 = (fRec27[0] * ((((9.03435581e-18f * (fTemp8 - fTemp17)) + (0.0737711117f * ((fTemp7 + fTemp18) - (fTemp9 + fTemp16)))) + (0.0414962508f * fTemp42)) + (0.0414962508f * ((fTemp20 + fTemp27) - (fTemp22 + fTemp25)))));
			fRec32[0] = max((fRec32[1] - fConst0), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp43))))));
			fVbargraph31 = FAUSTFLOAT(fRec32[0]);
			output5[i] = FAUSTFLOAT(fTemp43);
			float fTemp44 = (fTemp0 + fTemp5);
			float fTemp45 = (fRec27[0] * (((0.106479429f * fTemp44) + ((0.0212958846f * (fTemp18 + (fTemp17 + (fTemp16 + (fTemp10 + fTemp15))))) + (7.97957397e-18f * fTemp28))) - ((0.0532397144f * (fTemp4 + (fTemp3 + (fTemp1 + fTemp2)))) + (0.0425917692f * (fTemp14 + (fTemp13 + (fTemp11 + fTemp12)))))));
			fRec33[0] = max((fRec33[1] - fConst0), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp45))))));
			fVbargraph32 = FAUSTFLOAT(fRec33[0]);
			output6[i] = FAUSTFLOAT(fTemp45);
			float fTemp46 = (fRec27[0] * (((0.0737711117f * ((fTemp6 + fTemp17) - (fTemp8 + fTemp15))) + ((0.0414962508f * fTemp42) + ((4.5171779e-18f * (fTemp7 - fTemp16)) + ((0.0414962508f * (fTemp22 - fTemp27)) + (1.12929443e-17f * fTemp36))))) - ((1.35515337e-17f * (fTemp9 - fTemp18)) + (0.0414962508f * (fTemp20 - fTemp25)))));
			fRec34[0] = max((fRec34[1] - fConst0), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp46))))));
			fVbargraph33 = FAUSTFLOAT(fRec34[0]);
			output7[i] = FAUSTFLOAT(fTemp46);
			float fTemp47 = (fRec27[0] * (((3.45746707e-34f * fTemp44) + ((1.27045628e-17f * fTemp32) + (((4.5171779e-18f * fTemp11) + (2.25858887e-17f * fTemp13)) + (2.54091252e-18f * fTemp33)))) - ((0.0922138914f * ((fTemp2 + fTemp4) - (fTemp1 + fTemp3))) + (((((1.35515337e-17f * fTemp12) + (3.16202428e-17f * fTemp14)) + (7.62273735e-18f * fTemp30)) + (1.77863883e-17f * fTemp34)) + (0.0368855558f * ((fTemp18 + (fTemp16 + (fTemp7 + fTemp9))) - (fTemp17 + (fTemp15 + (fTemp6 + fTemp8)))))))));
			fRec35[0] = max((fRec35[1] - fConst0), min(6.0f, (20.0f * log10f(max(0.000316227757f, fabsf(fTemp47))))));
			fVbargraph34 = FAUSTFLOAT(fRec35[0]);
			output8[i] = FAUSTFLOAT(fTemp47);
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fRec4[1] = fRec4[0];
