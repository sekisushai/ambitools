...
public class Meter_Head extends PApplet {
...
public void setup() {
  //size(600,600,P3D);
  mesh=(TriangleMesh)new STLReader().loadBinary(sketchPath("face_tube_5000.stl"),STLReader.TRIANGLEMESH);
  mesh.scale(0.095f);
  mesh.rotateZ(-6*PI/7);
...
public void render() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "Meter_Head" };
    if (passedArgs != null) {
